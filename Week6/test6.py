...
conn = sqlite3.connect (r'D:\Atchariya_python\Week6\test6.db')
...
def show():
    ...
    with sqlite3.connect(r'D:\Atchariya_python\Week6\test6.db') as con:
...
while True:
    ...
    if king == 'a':
        ...
        print('\tออกจาโปรแกรม')
        e=str(input('\tต้องการออกจากระบบหรือไม่ yes/no : '))
        if e == 'yes':
            clear()
            break
    else:
